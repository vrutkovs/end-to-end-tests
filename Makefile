...
VM_VMCLUSTERDEFAULT_VMSELECTDEFAULT_VERSION ?= v1.122.14-cluster-enterprise

VM_VMCLUSTERDEFAULT_VMSTORAGEDEFAULT_IMAGE ?= quay.io/victoriametrics/vmstorage
VM_VMCLUSTERDEFAULT_VMSTORAGEDEFAULT_VERSION ?= $(VM_VMCLUSTERDEFAULT_VMSELECTDEFAULT_VERSION)

VM_VMCLUSTERDEFAULT_VMINSERTDEFAULT_IMAGE ?= quay.io/victoriametrics/vminsert
VM_VMCLUSTERDEFAULT_VMINSERTDEFAULT_VERSION ?= $(VM_VMCLUSTERDEFAULT_VMSELECTDEFAULT_VERSION)
